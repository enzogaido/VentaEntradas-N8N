...
**Backend conversacional para venta de entradas basado en estados utilizando n8n, PostgreSQL, Redis e inteligencia artificial.**
...
2. Configurar credenciales  
   ...
   - Redis  
   - OpenAI  
3. Crear las tablas usando los scripts de `database`  
